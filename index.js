...
const { handleStartApplication, handleApplicationSubmit, handleApplicationResponse } = require('./commands/basvuru/basvuru');
...
client.on('interactionCreate', async interaction => {
    if (interaction.isCommand()) {
        ...
        } else if (interaction.customId.startsWith('kabul_') || interaction.customId.startsWith('red_')) {
...
async function getLogChannel(guild, settingKey) {
    try {
        ...
        if (channelId) {
            ...
            console.log(`Bulunan kanal:`, channel ? channel.name : 'Kanal bulunamadı');
            return channel;
        } else {
...
client.on('messageDelete', async message => {
    ...
    try {
        ...
        console.log('Silinen mesaj için log kanalı:', logChannel ? logChannel.name : 'Bulunamadı');
